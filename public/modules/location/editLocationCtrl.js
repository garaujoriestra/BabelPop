angular.module("WallapopTFG").controller("editLocationCtrl", ["$scope", "checkAuth", "NgMap", "APIClient", "$state", "userDataStorage", "states", "errorHandler", function($scope, checkAuth, NgMap, APIClient, $state, userDataStorage, states, errorHandler) {
