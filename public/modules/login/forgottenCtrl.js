angular.module("WallapopTFG").controller("forgottenCtrl", ["$scope", "$state", "states", "apiPaths", "APIClient", "checkAuth", "errorHandler", function($scope, $state, states, apiPaths, APIClient, checkAuth, errorHandler) {
