angular.module("WallapopTFG").controller("mainLogLayoutCtrl", ["$scope", "$auth", "$state", "states", "checkAuth", "userDataStorage", "errorHandler", function($scope, $auth, $state, states, checkAuth, userDataStorage, errorHandler) {
