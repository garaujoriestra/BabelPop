angular.module("WallapopTFG").controller("customSignupCtrl", ["$auth", "$location", "$scope", "$state", "states", "checkAuth", "userDataStorage", function($auth, $location, $scope, $state, states, checkAuth, userDataStorage) {
