angular.module("WallapopTFG").controller("customLoginCtrl", ["$auth", "$location", "$scope", "$state", "states", "userDataStorage", "errorHandler", function($auth, $location, $scope, $state, states, userDataStorage, errorHandler) {
