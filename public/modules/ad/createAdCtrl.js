angular.module("WallapopTFG").controller("createAdCtrl", ["$scope", "$state", "states", "APIClient", "checkAuth", "Upload", "apiPaths", "$timeout", "userDataStorage", "errorHandler", function($scope, $state, states, APIClient, checkAuth, Upload, apiPaths, $timeout, userDataStorage, errorHandler) {
