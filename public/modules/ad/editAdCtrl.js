angular.module("WallapopTFG").controller("editAdCtrl", ["$scope", "$state", "states", "checkAuth", "userDataStorage", "Upload", "apiPaths", "$timeout", "APIClient", "errorHandler", function($scope, $state, states, checkAuth, userDataStorage, Upload, apiPaths, $timeout, APIClient, errorHandler) {
