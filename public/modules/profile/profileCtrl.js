angular.module("WallapopTFG").controller("profileCtrl", ["$scope", "$rootScope", "$auth", "$location", "$filter", "$translate", "checkAuth", "userDataStorage", "APIClient", "$state", "states", "userdetail", "errorHandler", function($scope, $rootScope, $auth, $location, $filter, $translate, checkAuth, userDataStorage, APIClient, $state, states, userdetail, errorHandler) {
