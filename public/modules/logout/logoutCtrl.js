angular.module("WallapopTFG").controller("logoutCtrl", ["$auth", "$scope", "checkAuth", "$state", "states", "userDataStorage", "errorHandler", function($auth, $scope, checkAuth, $state, states, userDataStorage, errorHandler) {
