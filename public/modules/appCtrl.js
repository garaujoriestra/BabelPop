angular.module("WallapopTFG").controller("appCtrl", ["$auth", "$scope", "$location", "usSpinnerService", "$state", "states", "$translate", "checkAuth", function($auth, $scope, $location, usSpinnerService, $state, states, $translate, checkAuth) {
