angular.module("WallapopTFG", ["ui.router", "satellizer", "angularSpinner",
    ...
    .config(["$stateProvider", "$urlRouterProvider", "$authProvider", "paths",
        ...
        function($stateProvider, $urlRouterProvider, $authProvider, paths,
                        ...
                        addetail: ["$stateParams", "APIClient", function($stateParams, APIClient) {
                            return APIClient.getDetailAd($stateParams._id).then(
                                function(ad) {
                                    ...
                                    console.log('RECIBO EN EL AD: ', ad);
                                    return { ad: ad };
                                },
                                function(err) {
                                    //$scope.$emit("stopLoadingState");
            ...
            $authProvider.tokenPrefix = "WallapopTFG";

            $authProvider.facebook({
                clientId: "502947646573417",
                url: "/api/auth/facebook"
            });

            $authProvider.google({
                clientId: "987287926090-auichn0scqoinkcd4k2g1nc73a1tg2fq.apps.googleusercontent.com",
                url: "/api/auth/google"
            });
